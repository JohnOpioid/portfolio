...
<div class="flex flex-col gap-0 min-h-screen bg-[url(/pattern.svg)] bg-center bg-repeat bg-contain bg-fixed">
  <div class="flex flex-col flex-grow px-6 md:px-12 pt-12 mb-12 gap-8 w-full xl:max-w-3/4 mx-auto">
    ...
    <div class="inline-block p-3 bg-white rounded-lg border border-slate-200/75 text-slate-500 shadow-xs max-w-85">
      ...
      <p class="mt-2">🌙 <span class="italic text-slate-500 text-lg">Да-да, даже ночью...</span></p>
    </div>
    ...
    <div class="max-w-70">
      <div class="p-1.5 bg-white rounded-lg border border-slate-200/75 text-slate-500 shadow-xs">
        <div class="flex flex-col ">
          ...
          <p class="p-1.5 text-slate-500 text-lg">Вы можете скачать мою цифровую визитку, нажав на кнопку ниже. 👇</p>
        </div>
      </div>
    ...
    <div class="inline-block max-w-75 bg-white rounded-lg border border-slate-200/75 text-slate-500 shadow-xs overflow-hidden">
      ...
      <p class="p-3 max-full text-slate-500 text-lg">По этому QR-коду можно перейти в мой Telegram канал. Не забудь подписаться. ☺️</p>
    </div>

    <div class="inline-flex items-center justify-center w-full">
        <hr class="w-full h-px my-8 bg-slate-200 border-0 dark:bg-gray-700">
        <span class="absolute px-6 py-1 font-medium text-slate-400 -translate-x-1/2 md:ms-20 lg:ms-40 bg-white left-1/2 dark:text-white dark:bg-gray-900 rounded-full border border-slate-200 uppercase">Обратная связь</span>
    </div>
    ...
    <div class="inline-block lg:max-w-2/3 xl:max-w-3/7 bg-white rounded-lg border border-slate-200/75 text-slate-500 shadow-xs overflow-hidden">
      <p class="p-3 max-full text-slate-500 text-lg">Вы можете описать свою задачу, заполнив форму обратной связи. Постараюсь не пропустить ваше письмо и ответить как можно быстрее. 🤭</p>
    </div>
